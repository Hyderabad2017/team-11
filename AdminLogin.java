...
public class AdminLogin extends AppCompatActivity {
    ...
    class BackgroundTask extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            progressDoalog = new ProgressDialog(AdminLogin.this);
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (success) {
                            ...
                            editor.commit();
                            Intent intent = new Intent(AdminLogin.this, DashBoardActivity.class);
                            finish();
                            startActivity(intent);
                        } else {
                            progressDoalog.dismiss();
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AdminLogin.this);
    ...
    public class LoginRequest extends StringRequest {
        private static final String LOGIN_REQUEST_URL = "https://hemanthraparthi.000webhostapp.com/CodeForGood/adminlogin.php";
